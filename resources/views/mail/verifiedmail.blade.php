                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="text-12 c-grey l-grey a-right py-20"
                                                        ...
                                                        <webversion class="link c-grey"
                                                            style="text-decoration:none; color:#6e6e6e;"><span
                                                                class="link c-grey"
                                                                style="text-decoration:none; color:#6e6e6e;">View this
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="btn-16 c-white l-white"
                                                                                                                    ...
                                                                                                                    <multiline>
                                                                                                                        <a href="{{ env("URL_TIENDA")."/login?code=".$user->uniqd }}"
                                                                                                                            target="_blank"
                                                                                                                            class="link c-white"
                                                            ...
                                                            <tr>
                                                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                                                    ...
                                                                    <multiline>
                                                                        ...
                                                                        Name
                                                                        <br />
                                                                        <a cm_dontconvertlink href="tel:+17384796719"
                                                                            target="_blank" class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;"><span
                                                                                class="link c-white"
                                                                                style="text-decoration:none; color:#ffffff;">(738)
                                                                                479-6719</span></a> - <a
                                                                            cm_dontconvertlink href="tel:+13697181973"
                                                                            target="_blank" class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;"><span
                                                                                class="link c-white"
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="text-12 lh-22 a-center c-grey- l-grey py-20"
                                                        ...
                                                        <forwardtoafriend class="link c-grey"
                                                            style="text-decoration:none; color:#6e6e6e;"><span
                                                                class="link c-grey"

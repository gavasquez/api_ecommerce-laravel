...
class CategorieResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            "categorie_second" => $this->resource->categori_second ? [
                "name" => $this->resource->categori_second->name,
            ] : null,
            "categorie_third_id" => $this->resource->categorie_third_id,
            "categorie_third" => $this->resource->categori_third ? [
                "name" => $this->resource->categori_third->name,
            ] : null,
